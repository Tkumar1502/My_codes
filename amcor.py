...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 10 09:35:30 2025
...
def save_lca_tables_to_excel():
    ...
    filename="./results/amcor/LCA_results_1.00perlb.xlsx"
...
def save_system_reports():
    folder = './results/amcor'
    #folder = os.path.join(folder, 'results')
    for scenario in ('experimental', 'NREL'):
        pm = process
        filename = f'amcor_{scenario}_detailed_report_1.00perlb.xlsx'
...
def save_detailed_expenditure_tables(sigfigs=3):
    folder = './results/amcor'
    #folder = os.path.join(folder, 'results')
    filename = 'expenditures_1.00perlb.xlsx'
    file = os.path.join(folder, filename)
