...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 11 15:13:36 2025
...
#define scenario
processing_capacity=5e3 #tons / year feedstock
...
#bounds 1-wash
process.set_polymer_mass_fraction.bounds=(.88, .95)
...
process.leftover_plastic.set_CF(GWP, 200)
...
def save_lca_tables_to_excel():
    ...
    filename="./results/cytiva/PE_EVOH_1wash/LCA_results.xlsx"
...
def save_detailed_expenditure_tables(sigfigs=3):
    folder = './results/cytiva/PE_only'   #set this to your own file directory
    #folder = os.path.join(folder, 'results')
...
def save_detailed_life_cycle_tables(sigfigs=3):
    ...
    folder = './results/cytiva/PE_EVOH_1wash'
