...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 15 11:33:56 2025
...
scenarios = [
    {
        ...
        "scenario": "PC/THF",
        "target_plastic_percent": 0.7,
        "sell_leftover_plastic": False,
        "burn_leftover_plastic": False,
        "facilities": False,
        "dissolution_temperature": 336,
        "feedstock_price": 0.05,
        "PC_resin_price": 2.50,
        "leftover_plastic_price": -0.062,
        "centrifuged_plastic_solvent_content": 50,
        "solvent_loss": 0.1,
        "dissolved_concentration": 7.5,
        "precipitation temperature": 308,
    },
    {
        "name": 'pc_lb',
        "processing_capacity": 2.5e3,
        "scenario": "PC/THF",
        "target_plastic_percent": 0.7,
        "sell_leftover_plastic": False,
        "burn_leftover_plastic": False,
    ...
    },
    {
        ...
        "PC_resin_price": 2.50,
        "leftover_plastic_price": -0.062,
        "centrifuged_plastic_solvent_content": 25,
        "solvent_loss": 0.1,
        "dissolved_concentration": 7.5,
        "precipitation temperature": 308,
    },
    {
        ...
        "PC_resin_price": 2.50,
        "leftover_plastic_price": -0.062,
        "centrifuged_plastic_solvent_content": 75,
        "solvent_loss": 0.1,
        "dissolved_concentration": 7.5,
        "precipitation temperature": 308,
    },
    {
        "name": 'solvent loss lb',
        "processing_capacity": 5e3,
        "scenario": "PC/THF",
        "target_plastic_percent": 0.7,
        "sell_leftover_plastic": False,
    ...
    },
    {
        ...
        "centrifuged_plastic_solvent_content": 25,
        "solvent_loss": 0.1,
        "dissolved_concentration": 5,
        "precipitation temperature": 308,
    },
    {
        "name": 'concentration ub',
        "processing_capacity": 5e3,
        "scenario": "PC/THF",
        "target_plastic_percent": 0.7,
        "sell_leftover_plastic": False,
...
for s in scenarios:
    ...
    process = strap.BaselineSTRAPProcess(
        scenario= s['scenario'],
        target_plastic_percent=s['target_plastic_percent'], # %
        processing_capacity=s['processing_capacity'], # MT/yr
        sell_leftover_plastic=s['sell_leftover_plastic'], #undissolved fraction
        burn_leftover_plastic=s['burn_leftover_plastic'], #waste to energy
    ...
    process.PC_resin.price = s['PC_resin_price']
    process.leftover_plastic.price = s['leftover_plastic_price']  #--> set to zero if not selling
    ...
    process.set_dissolution_temperature.baseline = s['dissolution_temperature']
    process.set_solvent_loss.baseline = s['solvent_loss']
    process.set_polymer_mass_fraction.baseline = s['target_plastic_percent']
    process.set_dissolution_capacity.baseline = s["dissolved_concentration"]
    process.set_precipitation_temperature.baseline = s["precipitation temperature"]
    process.set_feedstock_price.baseline=s['feedstock_price']
    process.set_centrifuged_plastic_solvent_content.baseline = s['centrifuged_plastic_solvent_content']
    ...
    #print('MSP for scenario', s['name'],':', process.MSP())
    print('IRR for scenario', s['name'],':', process.tea.solve_IRR())
